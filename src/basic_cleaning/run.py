...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--input_artifact", 
        type = str,
        help="The name of the input artifact, e.g., 'raw_data.csv:latest'.",
        required = True
    )
    ...
    parser.add_argument(
        "--output_artifact", 
        type = str,
        help="The name of the output artifact, e.g., 'clean_data.csv'.",
        required = True
    )
    ...
    parser.add_argument(
        "--min_price", 
        type = float,
        help="The minimum price to filter the dataset.",
        required = True
    )
    ...
    parser.add_argument(
        "--max_price",
        type = float,
        help="The maximum price to filter the dataset.",
        required = True
    )
